 ...
 * ensuring that all operations (even most user-provided {@link java.awt.image.BufferedImageOp}
 ...
 * between the two depending on the scaling hint provided (see {@link org.imgscalr.Scalr.Method}).
 * <p/>
 ...
 * {@link java.awt.RenderingHints#VALUE_INTERPOLATION_BICUBIC} scale operation look much
 * better, especially when using the {@link org.imgscalr.Scalr.Method#ULTRA_QUALITY} method.
 * <p/>
 * Only when scaling using the {@link org.imgscalr.Scalr.Method#AUTOMATIC} method will this class
 * look at the size of the image before selecting an approach to scaling the
 * image. If {@link org.imgscalr.Scalr.Method#QUALITY} is specified, the best-looking algorithm
 ...
 * {@link java.awt.RenderingHints#VALUE_INTERPOLATION_BICUBIC} interpolation is always
 ...
 * {@link java.awt.image.BufferedImage#flush()} on the interim temporary {@link java.awt.image.BufferedImage}
 ...
 * to disposing of the temporary {@link java.awt.Graphics2D} references as well).</li>
 ...
 * </ol>
 * <p/>
 * <strong>NOTE</strong>: This class does not call {@link java.awt.image.BufferedImage#flush()}
 ...
 * the original image unless a mode of {@link org.imgscalr.Scalr.Mode#FIT_EXACT} is specified; in
 ...
 * <p/>
 * When not using {@link org.imgscalr.Scalr.Mode#FIT_EXACT}, in order to maintain the
 ...
 * <li>If a {@link org.imgscalr.Scalr.Mode} value of {@link org.imgscalr.Scalr.Mode#FIT_TO_WIDTH} or
 * {@link org.imgscalr.Scalr.Mode#FIT_TO_HEIGHT} is passed in to the <code>resize</code> method,
 ...
 * source image. In many cases, especially when applying {@link java.awt.image.BufferedImageOp}
 ...
 * <ol>
 * <li>{@link java.awt.image.BufferedImage#TYPE_INT_RGB}</li>
 * <li>{@link java.awt.image.BufferedImage#TYPE_INT_ARGB}</li>
 * </ol>
 ...
 * {@link #apply(java.awt.image.BufferedImage, java.awt.image.BufferedImageOp...)} to apply your own ops to
 ...
 * {@link java.awt.image.IndexColorModel} is sub-par, both in accurate color-selection and in
 * maintaining transparency when moving to an image of type
 * {@link java.awt.image.BufferedImage#TYPE_INT_ARGB}; because of this issue when a GIF image
 ...
 * case of applying an optional {@link java.awt.image.BufferedImageOp}, lose the entire picture
 ...
 * RGB values pixel-by-pixel with a custom {@link java.awt.image.ColorModel} in the scaled
 ...
 * GIF implementation.
 * <p>
 * If the issue with optional {@link java.awt.image.BufferedImageOp}s destroying GIF image
 ...
 * <h3>Thread Safety</h3>
 * The {@link org.imgscalr.Scalr} class is <strong>thread-safe</strong> (as all the methods
...
public class Scalr {
	...
	/**
	 * A {@link java.awt.image.ConvolveOp} using a very light "blur" kernel that acts like an
	 ...
	 * {@link java.awt.image.AreaAveragingScaleFilter} (which is used internally by the
	 ...
	 * {@link java.awt.image.ConvolveOp#EDGE_NO_OP} instruction to not process the pixels along
	 ...
	 * <p/>
	 * This ConvolveOp uses no {@link java.awt.RenderingHints} values as internally the
	 * {@link java.awt.image.ConvolveOp} class only uses hints when doing a color conversion
	 * between the source and destination {@link java.awt.image.BufferedImage} targets.
	 * imgscalr allows the {@link java.awt.image.ConvolveOp} to create its own destination
	 * image every time, so no color conversion is ever needed and thus no
	 * hints.
	 * <h3>Performance</h3>
	 * Use of this (and other) {@link java.awt.image.ConvolveOp}s are hardware accelerated when
	...
	/**
	 * A {@link java.awt.image.RescaleOp} used to make any input image 10% darker.
	 * <p/>
	...
	/**
	 * A {@link java.awt.image.RescaleOp} used to make any input image 10% brighter.
	 * <p/>
	 * This operation can be applied multiple times in a row if greater than 10%
	 * changes in brightness are desired.
	 * 
	...
	/**
	 * A {@link java.awt.image.ColorConvertOp} used to convert any image to a grayscale color
	 * palette.
	 * <p/>
	...
	public static enum Method {
		 ...
		 * {@link org.imgscalr.Scalr#THRESHOLD_QUALITY_BALANCED} or
		 * {@link org.imgscalr.Scalr#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
		 ...
		 * beyond the work done by {@link org.imgscalr.Scalr.Method#QUALITY} to make the image look
		 ...
		 * jagged with some of the other {@link org.imgscalr.Scalr.Method}s (even
		 * {@link org.imgscalr.Scalr.Method#QUALITY}).
		 */
		ULTRA_QUALITY;
	}
	...
	public static enum Mode {
		 ...
		 * 
		 * See "Image Proportions" in the {@link org.imgscalr.Scalr} class description for
		 * more detail.
		 */
		AUTOMATIC,
		/**
		 ...
		 * modes or {@link org.imgscalr.Scalr.Mode#AUTOMATIC} if you want the image to look
	 ...
	 * {@link org.imgscalr.Scalr.Method#AUTOMATIC} method will decide if a {@link org.imgscalr.Scalr.Method#BALANCED}
	 * method will be used (if smaller than or equal to threshold) or a
	 * {@link org.imgscalr.Scalr.Method#SPEED} method will be used (if larger than threshold).
	 * <p/>
	 ...
	 * size need to use a {@link org.imgscalr.Scalr.Method#BALANCED} scale method to look decent in
	 * most all cases while using the faster {@link org.imgscalr.Scalr.Method#SPEED} method for
	...
	/**
	 * Threshold (in pixels) at which point the scaling operation using the
	 * {@link org.imgscalr.Scalr.Method#AUTOMATIC} method will decide if a {@link org.imgscalr.Scalr.Method#QUALITY}
	 * method will be used (if smaller than or equal to threshold) or a
	 * {@link org.imgscalr.Scalr.Method#BALANCED} method will be used (if larger than threshold).
	 * <p/>
	 * The bigger the image is being scaled to, the less noticeable degradations
	 * in the image becomes and the faster algorithms can be selected.
	 * <p/>
	 ...
	 * testing between different types of images scaled with this library; both
	 * photographs and screenshots. It was determined that images below this
	 * size need to use a {@link org.imgscalr.Scalr.Method#QUALITY} scale method to look decent in
	 * most all cases while using the faster {@link org.imgscalr.Scalr.Method#BALANCED} method for
	 * images bigger than this threshold showed no noticeable degradation over a
	...
	/**
	 * Used to apply, in the order given, 1 or more {@link java.awt.image.BufferedImageOp}s to
	 * a given {@link java.awt.image.BufferedImage} and return the result.
	 * <p/>
	 * <strong>Feature</strong>: This implementation works around <a
	 * href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4965606">a
	 * decade-old JDK bug</a> that can cause a {@link java.awt.image.RasterFormatException}
	 * when applying a perfectly valid {@link java.awt.image.BufferedImageOp}s to images.
	 * <p/>
	 * <strong>Feature</strong>: This implementation also works around
	 * {@link java.awt.image.BufferedImageOp}s failing to apply and throwing
	 * {@link java.awt.image.ImagingOpException}s when run against a <code>src</code> image
	 ...
	 * {@link java.awt.image.BufferedImageOp}s instead of relying on directly using the
	 * {@link java.awt.image.BufferedImageOp#filter(java.awt.image.BufferedImage, java.awt.image.BufferedImage)} method.
	 * <p/>
	 * <strong>Performance</strong>: Not all {@link java.awt.image.BufferedImageOp}s are
	 * hardware accelerated operations, but many of the most popular (like
	 * {@link java.awt.image.ConvolveOp}) are. For more information on if your image op is
	 ...
	 * {@link java.awt.image.BufferedImage#flush()} on the <code>src</code> to free up native
	 ...
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} that represents the <code>src</code>
	 ...
	 *             if one of the given {@link java.awt.image.BufferedImageOp}s fails to apply.
	 *             These exceptions bubble up from the inside of most of the
	 *             {@link java.awt.image.BufferedImageOp} implementations and are explicitly
	 ...
	 *             most common pitfalls that will cause {@link java.awt.image.BufferedImageOp}s
	 ...
	 * and applying any optional {@link java.awt.image.BufferedImageOp}s to the result before
	 * returning it.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 ...
	 *            unmodified.
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} representing the cropped region of
	 ...
	 * {@link java.awt.image.BufferedImageOp}s to it before returning the result.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 * {@link java.awt.Color#BLACK} to fill the extra padded space and then return the
	 * result.
	 * <p/>
	 ...
	 *            unmodified.
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} representing <code>src</code> with
	 ...
	 * to fill the extra padded space and then return the result. {@link java.awt.Color}s
	 ...
	 *            <code>src</code> is returned unmodified.
	 * @param color
	 *            The color to fill the padded space with. {@link java.awt.Color}s using
	 ...
	 * {@link java.awt.image.BufferedImageOp}s (if any) to the result before returning it.
	 * <p/>
	 * A scaling method of {@link org.imgscalr.Scalr.Method#AUTOMATIC} and mode of
	 * {@link org.imgscalr.Scalr.Mode#AUTOMATIC} are used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} representing the scaled
	 *         <code>src</code> image.
	 * 
	 * @throws IllegalArgumentException
	 *             if <code>src</code> is <code>null</code>.
	 ...
	 * method and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to the
	 * result before returning it.
	 * <p/>
	 * A mode of {@link org.imgscalr.Scalr.Mode#AUTOMATIC} is used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 * the given WIDTH or HEIGHT explicitly, depending on the {@link org.imgscalr.Scalr.Mode}
	 * specified) and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to the
	 * result before returning it.
	 * <p/>
	 * A scaling method of {@link org.imgscalr.Scalr.Method#AUTOMATIC} is used.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 *            given width ({@link org.imgscalr.Scalr.Mode#FIT_TO_WIDTH}) or fitting the image
	 *            to the given height ({@link org.imgscalr.Scalr.Mode#FIT_TO_HEIGHT}). If
	 *            {@link org.imgscalr.Scalr.Mode#AUTOMATIC} is passed in, imgscalr will calculate
	 ...
	 *            want to use {@link org.imgscalr.Scalr.Mode#AUTOMATIC} to "do the right thing".
	 * @param targetSize
	 *            The target width and height (square) that you wish the image
	 *            to fit within.
	 * @param ops
	 ...
	 * width and height and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to
	 ...
	 * explicitly, depending on the {@link org.imgscalr.Scalr.Mode} specified) and apply the given
	 * {@link java.awt.image.BufferedImageOp}s (if any) to the result before returning it.
	 * <p/>
	 * A scaling method of {@link org.imgscalr.Scalr.Method#AUTOMATIC} is used.
	 * <p/>
	 ...
	 * Resize a given image (maintaining its original proportion) to the target
	 * width and height (or fitting the image to the given WIDTH or HEIGHT
	 * explicitly, depending on the {@link org.imgscalr.Scalr.Mode} specified) using the given
	 * scaling method and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to
	 * the result before returning it.
	 * <p/>
	 * <strong>TIP</strong>: See the class description to understand how this
	 * class handles recalculation of the <code>targetWidth</code> or
	...
	/**
	 * Used to apply a {@link org.imgscalr.Scalr.Rotation} and then <code>0</code> or more
	 * {@link java.awt.image.BufferedImageOp}s to a given image and return the result.
	 * <p/>
	 * <strong>TIP</strong>: This operation leaves the original <code>src</code>
	 * image unmodified. If the caller is done with the <code>src</code> image
	 * after getting the result of this operation, remember to call
	 ...
	 *            the image.
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} representing <code>src</code> rotated
	 ...
	 *             operations.
	 * 
	 * @see org.imgscalr.Scalr.Rotation
	 */
	 ...
	 * {@link org.imgscalr.Scalr#DEBUG} is <code>true</code>; otherwise the VM will be
	 ...
	 * 
	 * @see org.imgscalr.Scalr#LOG_PREFIX
	 * @see org.imgscalr.Scalr#LOG_PREFIX_PROPERTY_NAME
	 */
	...
	/**
	 * Used to create a {@link java.awt.image.BufferedImage} with the most optimal RGB TYPE (
	 * {@link java.awt.image.BufferedImage#TYPE_INT_RGB} or {@link java.awt.image.BufferedImage#TYPE_INT_ARGB}
	 ...
	 * the result image; see {@link #copyToOptimalImage(java.awt.image.BufferedImage)} for
	 * that.
	 * <p/>
	 ...
	 * 
	 * @return a new {@link java.awt.image.BufferedImage} representing the most optimal target
	...
	/**
	 * Used to create a {@link java.awt.image.BufferedImage} with the given dimensions and the
	 * most optimal RGB TYPE ( {@link java.awt.image.BufferedImage#TYPE_INT_RGB} or
	 * {@link java.awt.image.BufferedImage#TYPE_INT_ARGB} ) capable of being rendered into from
	...
	/**
	 * Used to copy a {@link java.awt.image.BufferedImage} from a non-optimal type into a new
	 * {@link java.awt.image.BufferedImage} instance of an optimal type (RGB or ARGB). If
	 ...
	 *         typed {@link java.awt.image.BufferedImage}, otherwise <code>src</code> if it was
	...
	/**
	 * Used to determine the scaling {@link org.imgscalr.Scalr.Method} that is best suited for
	 * scaling the image to the targeted dimensions.
	 * <p/>
	 * This method is intended to be used to select a specific scaling
	 * {@link org.imgscalr.Scalr.Method} when a {@link org.imgscalr.Scalr.Method#AUTOMATIC} method is specified. This
	 * method utilizes the {@link org.imgscalr.Scalr#THRESHOLD_QUALITY_BALANCED} and
	 * {@link org.imgscalr.Scalr#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
	 ...
	 * 
	 * @return the fastest {@link org.imgscalr.Scalr.Method} suited for scaling the image to the
