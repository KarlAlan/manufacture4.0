 ...
 * class in new {@link java.util.concurrent.Callable} instances that are submitted to an internal
 * {@link java.util.concurrent.ExecutorService} for execution at a later date. A {@link java.util.concurrent.Future} is
 ...
 * is in the {@link java.util.concurrent.ExecutorService}'s queue. {@link java.util.concurrent.Future#get()} or
 * {@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit)} can be used to block on the
 * <code>Future</code>, waiting for the scale operation to complete and return
 * the resultant {@link java.awt.image.BufferedImage} to the caller.
 * <p/>
 ...
 * the returned {@link java.util.concurrent.Future} from any of the methods below.</li>
 * </ul>
 * <h3>Performance</h3>
 ...
 * {@link java.awt.image.BufferedImage} and stored in the JVM Heap space (decoded image
 ...
 * number of cores just to avoid having too many {@link java.awt.image.BufferedImage} instances
 ...
 * The {@link java.util.concurrent.ExecutorService} utilized by this class won't be initialized until
 ...
 * {@link java.util.concurrent.ThreadPoolExecutor} do not run in <code>daemon</code> mode; which
 ...
 * <p/>
 * If you have used the {@link org.imgscalr.AsyncScalr} class and are trying to shut down a
 * client application, you will need to call {@link #getService()} then
 * {@link java.util.concurrent.ExecutorService#shutdown()} or {@link java.util.concurrent.ExecutorService#shutdownNow()}
 * to have the threads terminated; you may also want to look at the
 * {@link java.util.concurrent.ExecutorService#awaitTermination(long, java.util.concurrent.TimeUnit)} method if you'd like
 ...
 * replace the terminated underlying {@link java.util.concurrent.ExecutorService} with a new one via
 * the {@link #createService()} method.
 * <h3>Custom Implementations</h3>
 * If a subclass wants to customize the {@link java.util.concurrent.ExecutorService} or
 * {@link java.util.concurrent.ThreadFactory} used under the covers, this can be done by overriding
 * the {@link #createService()} method which is invoked by this class anytime a
 * new {@link java.util.concurrent.ExecutorService} is needed.
 * <p/>
 * By default the {@link #createService()} method delegates to the
 * {@link #createService(java.util.concurrent.ThreadFactory)} method with a new instance of
 * {@link org.imgscalr.AsyncScalr.DefaultThreadFactory}. Either of these methods can be overridden and
 ...
 * {@link org.imgscalr.AsyncScalr.ServerThreadFactory} when creating the new {@link java.util.concurrent.ExecutorService}.
 * <p/>
 ...
 * <p/>
 * By default this class uses an {@link java.util.concurrent.ThreadPoolExecutor} internally to handle
 * execution of queued image operations. If a different type of
 * {@link java.util.concurrent.ExecutorService} is desired, again, simply overriding the
...
public class AsyncScalr {
	 ...
	 * underlying {@link java.util.concurrent.ExecutorService} will use to process async image
	 * operations.
	 * <p/>
	...
	/**
	 * Number of threads the internal {@link java.util.concurrent.ExecutorService} will use to
	...
	/**
	 * Used to get access to the internal {@link java.util.concurrent.ExecutorService} used by this
	 ...
	 * <p/>
	 * You can call {@link java.util.concurrent.ExecutorService#shutdown()} to wait for all scaling
	 * operations to complete first or call
	 * {@link java.util.concurrent.ExecutorService#shutdownNow()} to kill any in-process operations
	 * and purge all pending operations before exiting.
	 * <p/>
	 * Additionally you can use
	 * {@link java.util.concurrent.ExecutorService#awaitTermination(long, java.util.concurrent.TimeUnit)} after issuing a
	 * shutdown command to try and wait until the service has finished all
	 * tasks.
	 * 
	 * @return the current {@link java.util.concurrent.ExecutorService} used by this class to process
	 *         scale operations.
	 */
	...
	/**
	 * @see Scalr#apply(java.awt.image.BufferedImage, java.awt.image.BufferedImageOp...)
	 */
	...
	/**
	 * @see Scalr#crop(java.awt.image.BufferedImage, int, int, java.awt.image.BufferedImageOp...)
	 */
	...
	/**
	 * @see Scalr#crop(java.awt.image.BufferedImage, int, int, int, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> crop(final BufferedImage src,
	...
	/**
	 * @see Scalr#pad(java.awt.image.BufferedImage, int, java.awt.image.BufferedImageOp...)
	 */
	...
	/**
	 * @see Scalr#pad(java.awt.image.BufferedImage, int, java.awt.Color, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> pad(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, int, java.awt.image.BufferedImageOp...)
	 */
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Method, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Mode, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Method, Mode, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, int, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Method, int, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Mode, int, int, java.awt.image.BufferedImageOp...)
	 */
	public static Future<BufferedImage> resize(final BufferedImage src,
	...
	/**
	 * @see Scalr#resize(java.awt.image.BufferedImage, Method, Mode, int, int,
	...
	/**
	 * @see Scalr#rotate(java.awt.image.BufferedImage, Rotation, java.awt.image.BufferedImageOp...)
	 */
	 ...
	 * active {@link java.util.concurrent.ExecutorService} instance that can be used by this class.
	 * <p/>
	 * If <code>service</code> is <code>null</code>, has been shutdown or
	 * terminated then this method will replace it with a new
	 * {@link java.util.concurrent.ExecutorService} by calling the {@link #createService()} method
	 * and assigning the returned value to <code>service</code>.
	 * <p/>
	 * Any subclass that wants to customize the {@link java.util.concurrent.ExecutorService} or
	 * {@link java.util.concurrent.ThreadFactory} used internally by this class should override the
	 * {@link #createService()}.
	 */
	...
	/**
	 * Default {@link java.util.concurrent.ThreadFactory} used by the internal
	 * {@link java.util.concurrent.ExecutorService} to creates execution {@link Thread}s for image
	 * scaling.
	 * <p/>
	 * More or less a copy of the hidden class backing the
	 * {@link java.util.concurrent.Executors#defaultThreadFactory()} method, but exposed here to make
	...
	protected static class DefaultThreadFactory implements ThreadFactory {
		 ...
		 * {@link java.util.concurrent.ExecutorService} when processing queued up scale operations.
		 */
	...
	/**
	 * An extension of the {@link org.imgscalr.AsyncScalr.DefaultThreadFactory} class that makes two
	 ...
	 * by {@link org.imgscalr.AsyncScalr} to process images, but don't want to have to write
	 * the implementation.
	 * 
	 * @author Riyad Kalla (software@thebuzzmedia.com)
	 * @since 4.0
