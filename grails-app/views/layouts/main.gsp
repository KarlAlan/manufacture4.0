...
<li ${controllerName == 'task' ? ' class=active' : ''}>
    ...
    <ul class="submenu">
        ...
        <li ${controllerName == 'task'&&actionName == 'weekplanReport1' ? ' class=active' : ''}>
            <g:link controller="task" action="weekplanReport1">
                <i class="menu-icon fa fa-caret-right"></i>
                周计划统计报表
            </g:link>
...
<li ${controllerName == 'project'||controllerName == 'informationSystem'||controllerName == 'weeklyReport' ? ' class=active' : ''}>
    ...
    <ul class="submenu">
        ...
        <li ${controllerName == 'project'&&actionName == 'qualityReport1' ? ' class=active' : ''}>
            <g:link controller="project" action="qualityReport1">
                <i class="menu-icon fa fa-caret-right"></i>
                项目质量统计报表
            </g:link>
        ...
        <li ${controllerName == 'project'&&actionName == 'statusReport1' ? ' class=active' : ''}>
            <g:link controller="project" action="statusReport1">
                <i class="menu-icon fa fa-caret-right"></i>
                项目需求状态统计
            </g:link>
