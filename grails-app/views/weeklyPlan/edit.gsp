...
<html>
    ...
    <div class="row">
		<div id="edit-weeklyPlan" class="col-xs-12" role="main">
			...
			<g:form class="form-horizontal" role="form" url="[resource:weeklyPlanInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${weeklyPlanInstance?.version}" />
